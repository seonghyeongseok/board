...
<div align="center" class="container">
    ...
    <form action="list.php" method="post" onsubmit="return check()">
        ...
        <input type="text" name="findWord" id="text" placeholder="검색어">
        <input type="submit" value="검색" class="btn btn-default">
    </form>
    <br>
    <form action="list.php" method='post' class="pagination">
        <?php
        //  페이지 버튼
    ...
    <form action="loginTemplete.html" method="post">
        ...
        if (isset($_SESSION['id'])) {
            echo "<input type=\"submit\" value=\"로그아웃\" class=\"btn btn-default pull-right\"></form>";
            echo "<form action=\"writeTemplete.html\" method=\"post\">
                <input type=\"submit\" value=\"글 쓰기\" class=\"btn btn-default pull-right\">";
        } else {
